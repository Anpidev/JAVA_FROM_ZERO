...
class PanelFocos extends JPanel {
    ...
    // Clase que implementa FocusListener para manejar eventos de foco
    private class Focos implements FocusListener {

        @Override
        public void focusGained(FocusEvent e) {
            // Método llamado cuando el campo de texto gana el foco
            // En este caso, no se implementa ninguna acción
           System.out.println("ha ganada el foco");
        }
        ...
        public void focusLost(FocusEvent e) {
            ...
            if (e.getSource() == campoTexto1) {
                ...
                System.out.println("El cuadro dos ha perdido el foco");
            }
